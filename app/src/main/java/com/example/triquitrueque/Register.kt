...
class Register : AppCompatActivity() {
    ...
    private fun initialise() {
        etFirstName = findViewById<View>(R.id.etnombrer) as EditText
        etLastName = findViewById<View>(R.id.etapellidor) as EditText
        etEmail = findViewById<View>(R.id.etcorreo) as EditText
        etPassword = findViewById<View>(R.id.etContraseñar) as EditText
