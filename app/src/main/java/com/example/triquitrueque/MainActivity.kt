...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btPracticar.setOnClickListener{
            var intent = Intent(this,Practicar::class.java)
            startActivity(intent)
        }

        btunjugador.setOnClickListener{
            var intent = Intent(this,UnJugador::class.java)
            startActivity(intent)
        }
